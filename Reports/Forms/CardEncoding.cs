...
namespace Reports
{
    public partial class CardEncoding : Form
    {
        ...
        private async void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            var items = await services.CardEncodingAsync(dtDate.Value.Maximum(), txtSearch.Text,cboTerminal.SelectedValue.ToString());
        ...
        private async Task PopulateEncoding(IEnumerable<CardEncodingModel> items)
        {
           ...
           await Task.Run(() =>
           {
               ...
               foreach (var item in items)
               {
                   ...
                   dgEncoding[dtlEntranceGate.Index, row].Value = item.EntranceGate;
